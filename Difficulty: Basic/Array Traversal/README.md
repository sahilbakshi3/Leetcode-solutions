<h2><a href="https://www.geeksforgeeks.org/problems/array-traversal--120447/1?page=2&difficulty=Basic&status=unsolved&sortBy=accuracy">Array Traversal</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">You are given an array <strong>arr[]</strong> that contains integers. You need to print the elements of the array in a single line with a space between them.<br>Note: Don't add a new line at the end.</span></p>
